...
For a complete example of a smart contract that implements an action which returns a value see the [hello example contract](https://github.com/fullon-labs/flon.cdt/blob/main/examples/hello).

## Next Steps

* Compile the smart contract and deploy it to the FullOn testnet or any FullOn based blockchain.
