...
You can find the implementation of `eosio::binary_extension` within the CDT repository in the file [binary_extension.hpp](https://github.com/fullon-labs/flon.cdt/blob/main/libraries/eosiolib/core/eosio/binary_extension.hpp).
